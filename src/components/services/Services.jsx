    ...
    <div className='flex flex-col items-center justify-center w-full h-screen p-1'>
         <div className="block md:flex md:mx-auto md:max-w-6xl w-full h-full md:h-[90%] md:my-auto justify-between">
          <div className="flex flex-col md:h-full w-full h-[32%] md:w-[40%] pt-3 md:pt-0 md:justify-center ">
              <span className='font-medium text-lg text-center mb-3 md:text-start text-purple-600 uppercase p-2'>Access unlimited content</span>
              ...
              <p className='text-sm md:w-[90%] text-center md:text-start my-1 p-2'>Stream unlimited shows, listen to truth-seeking podcasts, and read articles you can relate to with your
