...
const Footer = () => {
  return (
    <div className='w-full h-[75vh] md:h-[55vh] mt-1 text-sm bg-cover bg-center bg-no-repeat text-white' style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/wbg3.avif)` }}>
        ...
        <div className="block md:flex h-[90%] md:h-[80%] border-b-2 border-orange-400">
            <div className="flex flex-col w-full md:w-[37%] md:h-[75%] ">
                <div className="flex flex-col">
                    ...
                    <p className='flex text-sm md:my-2'>For the word of God is living and active. Sharper than any double-edged sword, 
